...
Crops will be generated in the `scripts/resources/effects/new_thumbs` directory. If you're happy with what you got, just copy every thumbnails into the `scripts/resources/effects` directory.
